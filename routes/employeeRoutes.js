...
router.put('/update/:id', protect,authorize('superadmin', 'admin', 'clientAdmin'), authorizePermissions('update-employee'),  validateObjectId('id'), updateEmployee);
...
router.delete('/delete/:id', protect,authorize('superadmin', 'admin', 'clientAdmin'), authorizePermissions('delete-employee'),  validateObjectId('id'), softDeleteEmployee);
