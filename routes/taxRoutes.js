...
// @access  Private
router.put('/update/:id', protect,authorize('superadmin', 'admin', 'backOffice'),  validateObjectId('id'), updateTax);

// @route   DELETE /api/taxes/:id
// @desc    Delete a tax record
// @access  Private
router.delete('/delete/:id', protect,authorize('superadmin', 'admin', 'backOffice'),  validateObjectId('id'),deleteTax);
